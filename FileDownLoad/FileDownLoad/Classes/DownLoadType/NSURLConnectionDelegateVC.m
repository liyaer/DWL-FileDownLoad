...
#import "NSURLConnectionDelegateVC.h"

@interface NSURLConnectionDelegateVC ()<NSURLConnectionDataDelegate>
...
@implementation NSURLConnectionDelegateVC
...
-(UIProgressView *)progVDownloadFile
{
    ...
    {
        _progVDownloadFile = [[UIProgressView alloc] initWithFrame:CGRectMake(50, 250, 200, 0)];
    }
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    savePath = [savePath stringByAppendingPathComponent:@"NSURLConnectionDelegate-Font"];
